...
import Contact from '../getStarted/GetStarted';
        ...
        return(
            <div>
                ...
                <div className="nav-links-container">
                    <nav class = "nav-links"> 
                        <NavLink  to="/" className="text-links nav-space " style={({ isActive }) => {return {color: isActive ? "lightblue" : ""};}}> Home</NavLink>
                        <NavLink  to="gets-started" className="text-links" style={({ isActive }) => {return {color: isActive ? "lightblue" : ""};}}>Get Started</NavLink>
                    </nav>
                </div>
                    
                    <div className="social-media-container">
                        <a target="_blank"  href="https://www.linkedin.com/in/thomas-buscemi-2190b9218/" id = "linkedin">
                ...
                <Routes>
                    ...
                    <Route  path="gets-started" element={<Contact/>}/>
                </Routes>
                <div>
                <Footer/>
                </div>
