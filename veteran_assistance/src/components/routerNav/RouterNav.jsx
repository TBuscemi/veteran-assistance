                ...
                <div className = "logo"></div>
                    ...
                    <div className="social-media-container">
                        <a className="social-media-linkedin social-links" href="https://www.linkedin.com/in/thomas-buscemi-2190b9218/">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" className="bi bi-linkedin" viewBox="0 0 16 16">
                        ...
                        <a href="mailto:thomasbuscemi124@gmail.com" id = "email">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" fill="white" className="bi bi-email" viewBox="0 0 16 16">
